...
public class Board extends JFrame implements ActionListener {
    ...
    public Board(int size, int numMines) {
        ...
        for (int row = 0; row < size; row++) {
            for (int col = 0; col < size; col++) {
                ...
                this.add(current);
                this.grid[row][col].addActionListener(this);
            }
        }
    ...
    /**
     * 
     * determines an action based on the state of the square clicked...
     * needs to be updated
     * 
     * @param click
    ...
    public void actionPerformed(ActionEvent click) {
    	...
    	if(!initialized) {
        	...
        	System.out.println("you lose, you piece of shit!");
        } else {
        	System.out.println("you don't lose");
        }
    }

    /**
     * called by actionPerformed when the first square is clicked
     * generates a randomized Minesweeper board
     * 
     * @param clicked
     */
