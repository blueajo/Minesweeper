...
public class Board extends JFrame implements MouseListener {
	 ...
	 *//**
	 * 
	 * determines an action based on the state of the square clicked... needs
	 * to be updated
	 * 
	 * @param click
	 *            the ActionEvent generated by a click of a square
	 *//*
	 * @Override public void actionPerformed(ActionEvent click) { Square sq
	 * = (Square) click.getSource(); if (!initialized) { initialized = true;
	 * firstClick(sq); }
	 * 
	 * 
	 * else if (rightclick) { this.rightClickSquare(sq); }
	 * 
	 * 
	 * else { // leftclick this.leftClickSquare(sq); } }
	 */
	...
	public void mouseReleased(java.awt.event.MouseEvent e) {
		...
		int col = e.getX() / (size.width / this.grid.length);
		int row = e.getY() / (size.height / this.grid.length);
	 ...
	 */
	private static class Square extends JLabel implements MouseListener {
